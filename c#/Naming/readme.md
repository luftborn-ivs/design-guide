...
| Readonly variable name            | camelCase |    128 | No    | _     | No     | No           | [A-z][0-9]              | No          |
...
#### 10. Do use implicit type var for local variable declarations. Exception: primitive types (int, string, double, etc) might need to be explicit.
